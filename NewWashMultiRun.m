...
t0 = find(pGal>0);
t180 = find(pGal<0);
l=plot(real(torqGal(t0))*1e15/(r*m),imag(torqGal(t0))*1e15/(r*m),'o');
hold on
ll=plot(real(torqGal(t180))*1e15/(r*m),imag(torqGal(t180))*1e15/(r*m),'o', 'Color', [0.9290 0.6940 0.1250]);
lll=plot(mean(cGal)*1e15/(r*m),mean(sGal)*1e15/(r*m),'+',...
